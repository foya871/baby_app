...
class SearchVideoResultModel {
  ...
  SearchVideoResultModel.fromJson(Map<dynamic, dynamic> json) {
  ...
  static SearchVideoResultModel toBean(Map<String, dynamic> json) =>
      SearchVideoResultModel.fromJson(json);
}
