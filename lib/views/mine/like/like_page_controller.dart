 ...
 * @LastEditTime: 2025-06-28 09:18:39
 * @LastEditors: wdz
 * @Description: 
 * @FilePath: /baby_app/lib/views/mine/like/like_page_controller.dart
 */
...
class LikePageController extends GetxController
  ...
  getHttpData({required bool isRefresh, required int tabIndex}) {
    ...
    Api.getMyIntegrates(type: 4, sign: tabIndex, page: pageIndex[tabIndex]!)
        .then((response) {
      if (response != null) {
