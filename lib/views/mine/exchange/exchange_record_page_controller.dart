...
class ExchangeRecordPageController extends GetxController {
  EasyRefreshController refreshController = EasyRefreshController();
  PagingController<int, RedeemVipModel> pagingController =
  ...
  getHttpData({required bool isRefresh}) {
    ...
    Api.getRedeemRecord(page: pageIndex).then((response) {
